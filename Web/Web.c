...
/* Last-Modified: Wed, 18 Aug 2021 16:17:16 GMT */
const uint32_t imageLastModified = 1629303436U;

static const uint8_t imageFileData[28554U] = {
  ...
  0x20U,0x68U,0x72U,0x65U,0x66U,0x3DU,0x22U,0x2FU,0x64U,0x61U,0x74U,0x65U,0x74U,
...
static const imageFileItem imageFileTable[21U+1U] = {
  ...
  { 0x90CE4E8AU, &imageFileData[7655U]  },    // "keil.gif"
  { 0xD7FABA9AU, &imageFileData[8793U]  },    // "language.cgi"
  { 0x6314E402U, &imageFileData[9697U]  },    // "lcd.cgi"
  { 0xD1C9C758U, &imageFileData[10633U] },    // "leds.cgi"
  { 0x7049A0E1U, &imageFileData[12617U] },    // "llblue.jpg"
  { 0xA35A02C8U, &imageFileData[15625U] },    // "logo.gif"
  { 0xCEC97D75U, &imageFileData[17412U] },    // "network.cgi"
  { 0x3BDBDB05U, &imageFileData[19560U] },    // "pabb.gif"
  { 0x85C7B8E6U, &imageFileData[19681U] },    // "pg_footer.inc"
  { 0x1D1F9D3EU, &imageFileData[20107U] },    // "pg_header.inc"
  { 0x69E9F01DU, &imageFileData[21155U] },    // "system.cgi"
  { 0x5579E5A7U, &imageFileData[22406U] },    // "tcp.cgi"
  { 0xEEA8CB3DU, &imageFileData[23050U] },    // "xml_http.js"
  { 0xF266FE98U, &imageFileData[25866U] },    // "datetime.cgi"
  { 0x712A727DU, &imageFileData[28490U] },    // "td.cgx"
  { 0x00000000U, &imageFileData[28554U] }
};
